...
public class AddPayment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String PaymentStatus=request.getParameter("status");
            ...
            try {
                ...
                String query="insert into payments values('"+BillNo+"','"+PaymentFor+"','"+Amount+"','"+Time+"',"+
                        "'"+Date+"','"+PaymentMode+"','"+PaymentStatus+"')";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String PaymentFor=request.getParameter("name");
        ...
        String PaymentStatus=request.getParameter("status");
         System.out.println(PaymentStatus);
            ...
            try {
                ...
                String query="update payments set PaymentFor='"+PaymentFor+"',Amount='"+Amount+"'"+
                        ",PaymentMode='"+PaymentMode+"',PaymentStatus='"+PaymentStatus+"' where BillNo='"+BillNo+"'";
                System.out.println(query);
